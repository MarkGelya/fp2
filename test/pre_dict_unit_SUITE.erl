...
get_dataset() ->
    [% {"abc": 1}
     {pre_dict_node,
      #{97 =>
            {pre_dict_node,
             #{98 => {pre_dict_node, #{99 => {pre_dict_node, #{}, 1, true}}, undefined, false}},
             undefined,
             false}},
      undefined,
      false},
     ...
     {pre_dict_node,
      #{97 =>
            {pre_dict_node,
             #{98 => {pre_dict_node, #{99 => {pre_dict_node, #{}, 1, true}}, undefined, false},
               99 => {pre_dict_node, #{98 => {pre_dict_node, #{}, 2, true}}, undefined, false}},
             undefined,
             false}},
      undefined,
      false},
     ...
     {pre_dict_node,
      #{97 =>
            {pre_dict_node,
             #{98 =>
                   {pre_dict_node,
                    #{99 => {pre_dict_node, #{100 => {pre_dict_node, #{}, 3, true}}, 1, true}},
                    undefined,
                    false},
               99 => {pre_dict_node, #{98 => {pre_dict_node, #{}, 2, true}}, undefined, false}},
             undefined,
...
equal_test(_) ->
    ...
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(1, Dataset), T0)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(2, Dataset), T0)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(3, Dataset), T0)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(4, Dataset), T0)),
    T1 = pre_dict:insert("abc", 1, T0),
    ?assertEqual(false, pre_dict:equal(get_new_pre_dict(), T1)),
    ?assertEqual(true,
                 pre_dict:equal(
                     lists:nth(1, Dataset), T1)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(2, Dataset), T1)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(3, Dataset), T1)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(4, Dataset), T1)),
    T2 = pre_dict:insert("acb", 2, T1),
    ?assertEqual(false, pre_dict:equal(get_new_pre_dict(), T2)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(1, Dataset), T2)),
    ?assertEqual(true,
                 pre_dict:equal(
                     lists:nth(2, Dataset), T2)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(3, Dataset), T2)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(4, Dataset), T2)),
    T3 = pre_dict:insert("abcd", 3, T2),
    ?assertEqual(false, pre_dict:equal(get_new_pre_dict(), T3)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(1, Dataset), T3)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(2, Dataset), T3)),
    ?assertEqual(true,
                 pre_dict:equal(
                     lists:nth(3, Dataset), T3)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(4, Dataset), T3)),
    T4 = pre_dict:insert("ab", 4, T3),
    ?assertEqual(false, pre_dict:equal(get_new_pre_dict(), T4)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(1, Dataset), T4)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(2, Dataset), T4)),
    ?assertEqual(false,
                 pre_dict:equal(
                     lists:nth(3, Dataset), T4)),
    ?assertEqual(true,
                 pre_dict:equal(
                     lists:nth(4, Dataset), T4)).
